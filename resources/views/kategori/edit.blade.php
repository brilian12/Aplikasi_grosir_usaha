...
<div class="container-fluid">
    ...
    <div class="col-md-8 offset-md-2">
        <form  action="/updatekategori/{id}" method="POST" enctype="multipart/form-data" class="custom-form">
        {{ csrf_field() }}
        ...
        <a class="text-decoration-none" href="{{url('/kategori')}}">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-6 input-column"><input name="nama_kategori" value="{{ $edit->nama_kategori }}" class="form-control" type="text" /></div>
            </div>
